...
include("../Config/biblioteca.php"); // Asegúrate de tener un archivo con la conexión PDO
//hay que cambiar la conexion y los datos de la consulta;
ob_start();
...
class PDF extends FPDF {
    ...
    function ImprimirArchivo($datos) {
        foreach ($datos as $persona) {
            ...
            $this->MultiCell(0, 8, utf8_decode('ALUMNO:'));
            $this->SetFont('Arial', '', 12);
            $this->MultiCell(0, 8, utf8_decode("Id_alumno: {$persona['id_alumno']}"));
            ...
            $this->MultiCell(0, 8, utf8_decode("Curso: {$persona['curso']}"));
