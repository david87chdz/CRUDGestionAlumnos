...
if ($_SESSION['tipo_usuario'] === 'alumno') {
    ...
    header("Location: listar_profesor.php?error=Como alumno no puedes modificar");
    exit();
}

$titulo = "Actualizar tutor"; 
...
<form action="../Controlador/modificar_profesor.php" method="post">
     <label for="id">
    ...
    <label for="nuevoDni">
    <p>Numero DNI (Solo si se desea cambiar):</p><input type="text" name="nuevoDni">
    </label>
    <label for="nombre">
